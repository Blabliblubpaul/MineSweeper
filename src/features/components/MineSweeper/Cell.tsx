...
export default function Cell({x, y, state, nearbyMines, isHint, isBombHint, gameOverReveal, cellLeftClicked, cellRightClicked}: CellProps) {
    ...
    switch (state) {
        ...
        case 1:
            return <button className={"ms-cell" + (isBombHint ? " ms-cell-bomb-hint" : "")} onClick={handleLeftClick} onContextMenu={handleRightClick}><img className="cell-image" src="../images/flag.png" alt=""></img></button>
        ...
        case 3:
            return <div className={"ms-cell-container" + (gameOverReveal ? " ms-cell-container-game-over-reveal" : "")}><button className={"ms-cell ms-cell-opened"  + (gameOverReveal ? "" : "")} onClick={handleLeftClick} onContextMenu={handleRightClick}><img className="cell-image" src="../images/mine.png" alt=""></img></button></div>
